        ...
        <table style="width: 463px">
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label2" runat="server" Text="Khu:"></asp:Label>
                    </td>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label1" runat="server" Text="Tầng:"></asp:Label>
                    </td>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label3" runat="server" Text="Phòng:"></asp:Label>
                    </td>
                <td>
