    ...
    <table class="ok1"  >
        <tr>
            <td class="auto-style1">
                ...
                <asp:Button ID="btnDangnhap" runat="server" Font-Bold="true" BackColor="#ff9933" Text="Đăng nhập"  ForeColor="White" Height="32px" Width="115px" />
                <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/Xoa16.png" Height="16px" Width="16px" style="margin-left: 59px"  />
                <asp:Button ID="btnTrove" BackColor="Red" runat="server" Text="Trở về" ForeColor="White" Font-Bold="true" Height="32px" Width="77px" />
                <br />
                <br />
